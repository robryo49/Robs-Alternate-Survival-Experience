...
public class ForgeEmiRecipe implements EmiRecipe {
	...
	public void addWidgets(WidgetHolder widgets) {
		...
		widgets.addFillingArrow(62, 15, cookingTime*50).tooltip((mx, my) ->
				List.of(TooltipComponent.of(Text.translatable("emi.cooking.time", cookingTime / 20f).asOrderedText())));
